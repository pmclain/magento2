        ...
        'validate-item-quantity': [
            function (value, element, params) {
                ...
                if (!isMinAllowedValid) {
                    $.validator.messages[name] = $.mage.__('The minimum quantity allowed is') + ' ' + params.minAllowed;
                } else if (!isMaxAllowedValid) {
                    $.validator.messages[name] = $.mage.__('The maximum quantity allowed is') + ' ' + params.maxAllowed;
                } else if (!isQtyIncrementsValid) {
                    $.validator.messages[name] = $.mage.__('Quantity must be an increment of') + ' ' + params.qtyIncrements;
                }
